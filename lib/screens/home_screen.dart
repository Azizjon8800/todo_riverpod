...
import 'package:todo_riverpodd/providers/date_provider.dart';
import 'package:todo_riverpodd/providers/task/task_provider.dart';
...
class HomeScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final completedTasks = _competedTasks(taskState.tasks, ref);
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    ElevatedButton(
                      ...
                      style: ElevatedButton.styleFrom(backgroundColor: const Color.fromARGB(255, 67, 6, 180)),
                      child: const Padding(
  ...
  List<Task> _competedTasks(List<Task> tasks, WidgetRef ref) {
    final selectedDate = ref.watch(dateProvider);
